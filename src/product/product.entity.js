...
import { fileSchema } from "../file/file.entity.js";

const categories = ["სატვირთო", "მისაბმელიანი", "მაცივარი", "სამშენებლო ტექნიკა", "ზამთრის ტრანსპორტი", "წყლის ტრანსპორტი", "სხვა"];
...
const productSchema = new Schema({
	...
	images: { type: fileSchema, required: false },
	axle_configuration: {
		type: String,
